...
rating_table_1_data = [  # values are from test/resources/rating/generate_table_rating_test_data_1.sql
    [1, 0, 1223, 0],
    [1, 0, 1250.3, 0],
    [1, 0, 1281.7, 0],
    [1, 0, 1300, 0],
...
rating_table_2_data = [  # values are from test/resources/rating/generate_table_rating_test_data_2.sql
    [660, 6.6],
    [692.3, 77883.9],
    [722.1, 416998],
    [756, 1670400],
